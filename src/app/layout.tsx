...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://learn.ribeor.com",
  },
  ...
  openGraph: {
    ...
    description:
      "Plataforma educativa open source creada por Diego Berrio para aprender React, Hooks y arquitectura frontend moderna.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Ribeor Learn — Plataforma educativa",
      },
    ],
  },
  ...
  twitter: {
    ...
    title: "Ribeor Learn",
    description:
      "Aprende React y frontend moderno con una plataforma open source.",
    images: ["/og-image.png"],
    creator: "@diegoberrio",
  },
