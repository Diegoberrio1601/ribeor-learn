...
const contributions = [
  ...
  },
  {
    ...
    description:
      "Si no puedes contribuir con código, una donación ayuda a mantener servidores y herramientas.",
    action: "Donar dólares vía PayPal",
    ...
    features: [
      ...
      "Apoyo mediante dólares para el desarrollo continuo.",
    ],
    highlight: true,
  },
];
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-[50rem] mx-auto mb-16 text-center">
          ...
          <p className="text-n-3 text-lg md:text-xl leading-relaxed">
            ...
            contribuyendo con código o ayudando con dólares a cubrir los costos básicos.
          </p>
        </div>
